...
enum NeuroType {
  ...
  String get iconAsset => 'assets/images/$flameIconAsset';
  ...
  String get flameIconAsset => switch (this) {
    ...
    NeuroType.toc => 'profiles/toc.png',
    NeuroType.alexitimia => 'profiles/alexitimia.png',
    NeuroType.anhedonia => 'profiles/anhedonia.png',
    NeuroType.tag => 'profiles/tag.png',
  };
